...
export type CancelBookingEmailPayload = {
...
export function renderCancelBookingHTML(payload: CancelBookingEmailPayload) {
    ...
    <tr>
      <td align="center">
        <table width="600" style="background:#fff;border-radius:6px">
          <tr>
            <td style="background:#dc3545;color:#fff;padding:20px">
              <h1 style="margin:0;font-size:20px">THÔNG BÁO HỦY PHÒNG</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:24px;font-size:14px;line-height:1.6;color:#333">
              ...
              <p>
                Chúng tôi xin thông báo rằng đặt phòng của Quý khách tại <strong>${hotel_name}</strong> đã bị <strong>hủy</strong>.
                Thông tin chi tiết:
              </p>
