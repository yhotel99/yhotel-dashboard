...
> = {
  ...
  [PAYMENT_METHOD.EXTERNAL]: "Thanh toán trên nền tảng khác"
};
...
export const SIDEBAR_URLS = {
  ...
  RESERVATION_KANBAN: "/dashboard/reservation/kanban",
...
export const PATH_TO_RESOURCE: Record<string, string> = {
  ...
  [SIDEBAR_URLS.RESERVATION_KANBAN]: "reservations",
...
export const ROOM_CATEGORY_CODE = {
  ...
  SUPERIOR_TWIN_CITY_VIEW: "SUPERIOR_TWIN_CITY_VIEW",
  SUPERIOR_TWIN_CITY_VIEW_HIGH_FLOOR: "SUPERIOR_TWIN_CITY_VIEW_HIGH_FLOOR",
  SUPERIOR_KING_CITY_VIEW: "SUPERIOR_KING_CITY_VIEW",
  SUPERIOR_KING_CITY_VIEW_HIGH_FLOOR: "SUPERIOR_KING_CITY_VIEW_HIGH_FLOOR",
  EXECUTIVE_KING_NINH_KIEU_VIEW: "EXECUTIVE_KING_NINH_KIEU_VIEW",
  EXECUTIVE_KING_CAN_THO_BRIDGE_VIEW: "EXECUTIVE_KING_CAN_THO_BRIDGE_VIEW",
  MAINTENANCE: "MAINTENANCE"
} as const;
...
> = {
  ...
  [ROOM_CATEGORY_CODE.SUPERIOR_TWIN_CITY_VIEW]: "Superior Twin City View",
  [ROOM_CATEGORY_CODE.SUPERIOR_TWIN_CITY_VIEW_HIGH_FLOOR]:
    "Superior Twin City View High Floor",
  [ROOM_CATEGORY_CODE.SUPERIOR_KING_CITY_VIEW]: "Superior King City View",
  [ROOM_CATEGORY_CODE.SUPERIOR_KING_CITY_VIEW_HIGH_FLOOR]:
    "Superior King City View High Floor",
  [ROOM_CATEGORY_CODE.EXECUTIVE_KING_NINH_KIEU_VIEW]:
    "Executive King Ninh Kieu View",
  [ROOM_CATEGORY_CODE.EXECUTIVE_KING_CAN_THO_BRIDGE_VIEW]:
    "Executive King Can Tho Bridge View",
