...
// Query keys
export const roomMapKeys = {
  all: ["room-map"] as const,
  list: () => [...roomMapKeys.all, "list"] as const,
};

// Fetch room map query function
export async function fetchRoomMapQuery(): Promise<RoomWithBooking[]> {
