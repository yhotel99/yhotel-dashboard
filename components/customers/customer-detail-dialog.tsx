              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-base ">{customer.source ? customerSourceLabels[customer.source as keyof typeof customerSourceLabels].charAt(0).toUpperCase() + customerSourceLabels[customer.source as keyof typeof customerSourceLabels].slice(1) : "-"}</p>
                  </div>
                </div>
              </div>
