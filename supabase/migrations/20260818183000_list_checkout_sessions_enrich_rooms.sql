-- Enrich list_checkout_sessions.rooms jsonb (type/nights/amount) and search by room.
-- Safe to re-run if 20260818120000 already applied with the thinner rooms payload.
