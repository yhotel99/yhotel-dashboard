-- Nâng cấp từ overload 4/5 tham số lên bản đầy đủ (keyset + next_cursor + DISTINCT).
-- Đồng bộ với public.list_bookings_json trong 20260328120000_list_bookings_json.sql
