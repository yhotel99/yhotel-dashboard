-- Migration: Update create_booking_secure to use booking_rooms
-- Add create_multi_booking_secure for multi-room booking + thanh toán 1 lần

-- ============================================================================
-- 1. UPDATE create_booking_secure - insert vào booking_rooms
-- ============================================================================
...
BEGIN
  ...
  VALUES (p_customer_id, p_room_id, p_check_in, p_check_out, p_number_of_nights, p_total_guests, 'pending', p_notes, p_total_amount, p_advance_payment, v_booking_code, now())
  RETURNING id INTO v_booking_id;

  INSERT INTO booking_rooms (booking_id, room_id, check_in, check_out, number_of_nights, amount, status, created_at)
  VALUES (v_booking_id, p_room_id, p_check_in, p_check_out, p_number_of_nights, p_total_amount, 'pending', now());
...
-- ============================================================================
-- 2. CREATE create_multi_booking_secure - nhiều phòng, thanh toán 1 lần
-- ============================================================================
