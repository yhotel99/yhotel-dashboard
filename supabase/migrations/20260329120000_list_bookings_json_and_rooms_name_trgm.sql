-- Tổng hợp một lần (để push môi trường mới / repair) từ:
--   20260328120000_list_bookings_json.sql
--   20260329103000_list_bookings_json_status_param.sql (cùng nội dung RPC với file trên)
--   20260329104500_idx_rooms_name_trgm.sql
-- Thứ tự: extension → index GIN → RPC + quyền.
