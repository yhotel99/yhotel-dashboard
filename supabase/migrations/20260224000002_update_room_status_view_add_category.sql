-- ============================================================================
-- Migration: Update room_status_view to include category_code
-- Created: 2026-02-24
-- Description: Thêm category_code vào room_status_view
-- ============================================================================

-- Drop existing view first
DROP VIEW IF EXISTS public.room_status_view;

-- Recreate view with category_code
...
COMMENT ON VIEW public.room_status_view IS 'View hiển thị trạng thái phòng với thông tin booking hiện tại, bao gồm category_code';
