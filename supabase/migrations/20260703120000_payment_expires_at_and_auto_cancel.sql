-- Payment expiry (10 min) for website online payments + server-side auto-cancel
--
-- PROD-SAFE:
-- - No backfill on existing pending bookings (avoids mass-cancel on deploy).
-- - payment_expires_at is set only for NEW website online-payment bookings.
-- - Cron cancels only website bookings with an explicit expired payment_expires_at.
...
-- System-initiated cancel (no branch access check — for pg_cron / website checkout)
...
-- ============================================================================
-- create_booking_secure: payment_expires_at for website online payments (10 min)
-- ============================================================================
...
-- ============================================================================
-- create_multi_booking_secure: payment_expires_at for website online payments
-- ============================================================================
